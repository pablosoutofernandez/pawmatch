<div class="w-full flex items-start paw-canvas min-h-screen">
    ...
    <div class="flex-1 min-w-0 min-h-screen pb-20">
        ...
        @php
            // Etiqueta y color para la compatibilidad
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10 pt-6 sm:pt-10">
            ...
            <div class="flex items-center justify-between gap-3 mb-6 animate-fade-up">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @else
                        ...
                        @endif
                        <button wire:click="darLike" @if($yaLike) disabled @endif
                        class="inline-flex items-center gap-2 font-semibold text-sm px-5 py-2 rounded-full shadow-soft transition-all active:scale-[.97]
                                       {{ $esMatch
                                            ? 'bg-brand-100 text-brand-600 cursor-default'
                                            : ($yaLike
                                                ? 'bg-cream-200 text-ink-700/50 cursor-default'
                                                : 'bg-gradient-to-br from-brand-400 to-brand-600 text-white hover:from-brand-500 hover:to-brand-700') }}">
                            @if($esMatch) 💞 ¡Match!
                            @elseif($yaLike) ✓ Like enviado
                            @else
            ...
            @if($perro)
                {{-- ════════════════════════════════════════════════════
                     HÉROE — Carné de la manada (el perro es la estrella)
                ════════════════════════════════════════════════════ --}}
                <div class="soft-card overflow-hidden animate-pop-in">
                    <div class="grid md:grid-cols-[minmax(0,1fr)_1.1fr]">
                        ...
                        <div class="relative aspect-square md:aspect-auto md:min-h-[26rem] bg-gradient-to-br from-brand-100 via-cream-200 to-sage-100">
                            ...
                            {{-- Sello tipo "carné" arriba a la izquierda --}}
                        ...
                        <div class="p-6 sm:p-8 flex flex-col">
                            ...
                            {{-- Dueño, en la base de la tarjeta --}}
                            <div class="mt-auto pt-6">
                                <div class="flex items-center gap-3 border-t border-cream-200 pt-4">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-[11px] text-ink-700/45 font-semibold">Su humano</p>
                ...
                {{-- ════════════════════════════════════════════════════
                     COMPATIBILIDAD — protagonista en perfiles ajenos
                ════════════════════════════════════════════════════ --}}
                    ...
                    <div class="soft-card p-6 sm:p-7 mt-6 animate-fade-up overflow-hidden relative">
                        <div class="flex items-center gap-5 sm:gap-7 flex-wrap">
                            ...
                            <div class="min-w-0 flex-1">
                                <p class="text-[11px] text-ink-700/45 font-bold uppercase tracking-wider">Compatibilidad entre vuestros perros</p>
                ...
                {{-- ════════════════════════════════════════════════════
                     DETALLE — descripción, ficha completa, dueño
                ════════════════════════════════════════════════════ --}}
                            ...
                            <div class="grid sm:grid-cols-2 gap-x-8 gap-y-px">
                                ...
                                @php
                                    $bools = [
                                        ...
                                        ['Con perros pequeños', $perro->compatible_pequenos],
                                        ['Con perros grandes',  $perro->compatible_grandes],
                                    ];
                                @endphp
